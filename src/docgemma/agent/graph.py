...
_TOOL_STATUS_POOLS: dict[str, list[str]] = {
    "check_drug_safety": [
        ...
        "Querying drug safety records...",
        "Consulting FDA drug labels...",
    ],
    ...
    "search_medical_literature": [
        ...
        "Consulting PubMed...",
        "Scanning clinical studies...",
        "Querying research databases...",
    ],
    "find_clinical_trials": [
        "Searching clinical trials...",
        "Looking up active trials...",
        "Checking trial registries...",
        "Browsing ClinicalTrials.gov...",
        "Scanning trial databases...",
    ],
    "add_allergy": [
        "Documenting allergy...",
        "Recording allergy information...",
        "Updating allergy records...",
        "Adding to allergy list...",
    ],
    "prescribe_medication": [
        "Processing prescription...",
        "Preparing medication order...",
        "Creating prescription record...",
        "Filing medication order...",
    ],
    "save_clinical_note": [
